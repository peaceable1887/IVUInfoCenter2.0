<?php
/*
Plugin Name: AKADEMIE / EVENTS (Meine Unterlagen)
Description: .....
Version: 1.0.0
Author: Felix Hansmann
*/
add_shortcode("shortcode_alleUnterlagen", "dbQuery_alleUnterlagen");

function dbQuery_alleUnterlagen()
{
    ...
    echo "<th style='color: #b72a37; font-weight: bold;'>Unterlagen</th>\n";
    echo "</td>\n";
