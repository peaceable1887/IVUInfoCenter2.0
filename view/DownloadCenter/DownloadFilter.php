    ...
    function testshowSortDownloads()
    {
        $content = " <form method='post'><div class='filterContainer'>
                        ...
                        <div class='dropDown'>                       
                            ...
                            <div class='dropDownContent'>
                                <input class='dropDownBtn' type='submit' name='sortCategory' value='LOGA'><br>
                                <input class='dropDownBtn' type='submit' name='sortCategory' value='Ener:gy'><br>
                                <input class='dropDownBtn' type='submit' name='sortCategory' value='CS2''><br>
                                <input class='dropDownBtn' type='submit' name='sortCategory' value='BelVis'><br>                                                                       
                            </div>                             
                        </div>
                        <div class='dropDown'>                       
                            <button class='dropDownBtn'>Subkategorie wählen<span class='arrowDown'>&#129107;</span></button>
                            <div class='dropDownContent'>
                                <input class='dropDownBtn' type='submit' name='sortCategory' value='Seminarunterlagen'><br>
                                <input class='dropDownBtn' type='submit' name='sortByEnergy' value='Updates'><br>
                                <input class='dropDownBtn' type='submit' name='sortByCsTwo' value='LOGA3'><br>
                                <input class='dropDownBtn' type='submit' name='sortByBelvis' value='Aktuelles Release'><br>                                                                       
                            </div>                             
                        </div>                                                            
